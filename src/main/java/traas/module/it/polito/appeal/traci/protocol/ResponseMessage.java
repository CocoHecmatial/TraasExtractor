...
//
/****************************************************************************/
package traas.module.it.polito.appeal.traci.protocol;
 ...
 * @author Enrico Gueli &lt;enrico.gueli@polito.traas.module.it&gt;
 *
 */
public class ResponseMessage {
     ...
     * <li>if the status ID is equal to {@link Constants#CMD_SIMSTEP}, traas.module.it is
     * expected an integer representing N and N following sub-responses;</li>
     * <li>if the status ID matches one of the commands in
     * {@link #STATUS_ONLY_RESPONSES} , traas.module.it is expected another status response;
     * <li>if the status ID doesn't match any of the above, traas.module.it is expected a
     * response command.
     * </ul>
