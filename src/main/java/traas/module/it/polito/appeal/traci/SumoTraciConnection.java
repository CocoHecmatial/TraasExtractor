...
//
/****************************************************************************/
package traas.module.it.polito.appeal.traci;
...
import traas.module.de.tudresden.sumo.util.CommandProcessor;
import traas.module.de.tudresden.sumo.util.Observer;
...
public class SumoTraciConnection {
    ...
    /**
     * Adds a custom option to the SUMO command line before executing traas.module.it.
     *
     * @param option
    ...
    /**
     * Runs a SUMO instance and tries to connect at traas.module.it.
     *
     * @throws IOException
    ...
    /**
     * Closes the connection, eating the {@link InterruptedException} traas.module.it may
