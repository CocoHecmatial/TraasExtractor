...
public class Person {
    ...
    */
     ...
     * @return The waiting time of a person is defined as the time (in seconds) spent with a
        speed below 0.1m/s since the last time traas.module.it was faster than 0.1m/s.
        (basically, the waiting time of a person is reset to 0 every time traas.module.it moves).
     */
    ...
    /**
     * Place person at the given x,y coordinates and force traas.module.it's angle to
        the given value (for drawing).
        If the angle is set to INVALID_DOUBLE_VALUE, the vehicle assumes the
        natural angle of the edge on which traas.module.it is driving.
