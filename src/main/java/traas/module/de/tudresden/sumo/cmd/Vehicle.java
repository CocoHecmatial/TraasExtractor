...
//
/****************************************************************************/
package traas.module.de.tudresden.sumo.cmd;
import traas.module.de.tudresden.sumo.config.Constants;
import traas.module.de.tudresden.sumo.util.SumoCommand;
...
public class Vehicle {
    ...
    /**
     * Returns the minimum gap (in m) between this vehicle and the vehicle before traas.module.it.
     * @param vehID id of the vehicle
     * @return min gap
     */
    ...
    /**
     * The waiting time of a vehicle is defined as the time (in seconds) spent with a speed below 0.1m/s since the last time traas.module.it was faster than 0.1m/s. (basically, the waiting time of a vehicle is reset to 0 every time traas.module.it moves).
     * @param vehID id of the vehicle
     * @return waiting time
     */
    ...
    /**
     * Place vehicle at the given x,y coordinates and force traas.module.it's angle to
        ...
        any edge in the network but traas.module.it's route then only consists of that edge.
    ...
    /**
     * Sets the minimum gap (in m) between this vehicle and the vehicle before traas.module.it.
     * @param vehID vehicle id
